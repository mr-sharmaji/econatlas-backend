...
- [TOOL:future_prospects:{"symbol":"TCS"}] — Future-growth evidence for a stock built from structured stock signals already in the backend, stored prospect evidence, and near-term company events. Use for "future prospects of TCS", "can Reliance grow from here", "future growth potential of Infosys", or "long-term outlook for HDFC Bank".
...
| "Future prospects of TCS" / "Can Reliance grow from here?" / "Long-term outlook for HDFC Bank" | `future_prospects({"symbol":"TCS"})` — use the structured stock evidence and event context, then explain what supports growth, what can limit it, and your view. |
...
_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "future_prospects": "Forward-looking evidence for a stock using structured stock signals, stored outlook evidence, and near-term company-event context.",
