...
def get_arq_functions() -> list:
    ...
    return [
        ...
        func(task_discover_stock, name="discover_stock"),
        func(task_discover_mutual_funds, name="discover_mutual_funds"),
        func(task_discover_stock_price, name="discover_stock_price"),
        func(task_discover_mf_nav, name="discover_mf_nav"),
