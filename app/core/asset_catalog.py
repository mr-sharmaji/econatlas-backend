...
ASSET_CATALOG: tuple[AssetCatalogItem, ...] = (
    ...
    AssetCatalogItem("platinum", "commodity", "PL=F", "Commodities", "NYSE", "rolling_24h", 720, "commodity", "usd_per_troy_ounce", False, "gold"),
    AssetCatalogItem("palladium", "commodity", "PA=F", "Commodities", "NYSE", "rolling_24h", 730, "commodity", "usd_per_troy_ounce", False, "gold"),
    AssetCatalogItem("copper", "commodity", "HG=F", "Commodities", "NYSE", "rolling_24h", 740, "commodity", "usd_per_pound", False, "gold"),
    AssetCatalogItem("crude oil", "commodity", "CL=F", "Commodities", "NYSE", "rolling_24h", 750, "commodity", "usd_per_barrel", False, "gold"),
    AssetCatalogItem("brent crude", "commodity", "BZ=F", "Commodities", "NYSE", "rolling_24h", 760, "commodity", "usd_per_barrel", False, "gold"),
    AssetCatalogItem("natural gas", "commodity", "NG=F", "Commodities", "NYSE", "rolling_24h", 770, "commodity", "usd_per_mmbtu", False, "gold"),
    # Bonds
