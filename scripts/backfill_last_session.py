"""Backfill recent trading sessions' daily data (market + commodities) and intraday data.

Use this to refresh or backfill recent trading days when the scheduler missed runs
